...
if (!($ADApplicationID)) {   
    ...
    try {   
        ...
        $ADApplicationSecret = az ad app credential reset --id $ADObjectID --append --display-name 'SaaSAPI' --end-date '2025-10-31' --query password --only-show-errors --output tsv
